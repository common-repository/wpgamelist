<?php
/**
 * WPGameList Library Display Options Tab Class
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPGameList_Library_Display_Options_Tab', false ) ) :
/**
 * WPGameList_Admin_Menu Class.
 */
class WPGameList_Library_Display_Options_Tab {

    public function __construct() {
    	require_once(GAMELIST_GAMELIST_CLASS_DIR.'class-admin-ui-template.php');
    	require_once(GAMELIST_GAMELIST_CLASS_DIR.'class-library-display-options-form.php');
    	// Instantiate the class
		$this->template = new WPGameList_Admin_UI_Template;
		$this->form = new WPGameList_Library_Display_Options_Form ;
    ...
    private function output_open_admin_container(){
        $title = __('Library Display Options', 'wpgamelist');
        $icon_url = GAMELIST_GAMELIST_ROOT_IMG_ICONS_URL.'block.svg';
...
// Instantiate the class
$am = new WPGameList_Library_Display_Options_Tab;