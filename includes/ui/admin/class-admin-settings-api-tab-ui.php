...
if ( ! class_exists( 'WPGameList_Api_Settings', false ) ) :
/**
 * WPGameList_Api_Settings Class.
 */
class WPGameList_Api_Settings {

    public function __construct() {
        require_once(GAMELIST_GAMELIST_CLASS_DIR.'class-admin-ui-template.php');
        require_once(GAMELIST_GAMELIST_CLASS_DIR.'class-api-settings-form.php');
        // Instantiate the class
        $this->template = new WPGameList_Admin_UI_Template;
        $this->form = new WPGameList_Api_Settings_Form;
    ...
    private function output_open_admin_container(){
        $title = __('API Settings','wpgamelist');
        $icon_url = GAMELIST_GAMELIST_ROOT_IMG_ICONS_URL.'game-controller-1.svg';
...
// Instantiate the class
$cm = new WPGameList_Api_Settings;