...
class WPGameList_AddAGame_Tab {
    ...
    public function __construct() {
    	...
    	require_once(GAMELIST_GAMELIST_CLASS_DIR.'class-templatepaks-form.php');
    ...
    private function output_open_admin_container(){
        $icon_url = GAMELIST_GAMELIST_ROOT_IMG_ICONS_URL.'seo-template.svg';
        $title = __('Template Paks','wpgamelist');
