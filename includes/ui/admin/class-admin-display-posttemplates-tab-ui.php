<?php
/**
 * WPGameList PostTemplates Display Options Tab Class
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPGameList_PostTemplates_Display_Options_Tab', false ) ) :
/**
 * WPGameList_Admin_Menu Class.
 */
class WPGameList_PostTemplates_Display_Options_Tab {

    public function __construct() {
        require_once(GAMELIST_GAMELIST_CLASS_DIR.'class-admin-ui-template.php');
        require_once(GAMELIST_GAMELIST_CLASS_DIR.'class-posttemplates-display-options-form.php');
        // Instantiate the class
        $this->template = new WPGameList_Admin_UI_Template;
        $this->form = new WPGameList_PostTemplates_Display_Options_Form ;
    ...
    private function output_open_admin_container(){
        $title = __('Post Templates', 'wpgamelist');
...
// Instantiate the class
$am = new WPGameList_PostTemplates_Display_Options_Tab;