...
class WPGameList_AddAGame_Tab {
    ...
    public function __construct() {
    	...
    	require_once(GAMELIST_GAMELIST_CLASS_DIR.'class-extensions-form.php');
    ...
    private function output_open_admin_container(){
        $icon_url = GAMELIST_GAMELIST_ROOT_IMG_ICONS_URL.'tetris.svg';
        $title = __('Extensions','wpgamelist');
