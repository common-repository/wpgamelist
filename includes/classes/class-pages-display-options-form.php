...
if ( ! class_exists( 'WPGameList_Pages_Display_Options_Form', false ) ) :
/**
 * WPGameList_Admin_Menu Class.
 */
class WPGameList_Pages_Display_Options_Form {
    ...
    <div class="wpgamelist-spinner" id="wpgamelist-spinner-2"></div>
        <table id="wpgamelist-jre-backend-options-table">
            ...
            if(has_filter('wpgamelist_add_to_page_display_options')) {
                $string57 = $string57.apply_filters('wpgamelist_add_to_page_display_options', $hide_array);
            }
            ...
            $string61 = '';
            if(has_filter('wpgamelist_append_to_display_options_page_enable_purchase')) {
                $string61 = apply_filters('wpgamelist_append_to_display_options_page_enable_purchase', $string61);
            }
        

        $string62 = '<button id="wpgamelist-save-page-backend" name="wpgamelist-input-34" type="button">Save Changes</button></div>';
